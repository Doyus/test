...
<script lang="ts">
  ...
  import { getAllList as getCrontabList } from '/@/views/gxadmin/system/celery/crontab/api';
  import { getAllList as getIntervalList } from '/@/views/gxadmin/system/celery/interval/api';
  import { getCrontabData, getIntervalData } from '/@/views/gxadmin/system/celery/util';
