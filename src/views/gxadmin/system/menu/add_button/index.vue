...
<script lang="ts">
  ...
  import MenuButtonDrawer from '/@/views/gxadmin/system/menu/add_button/MenuButtonDrawer.vue';
  import { useI18n } from '/@/hooks/web/useI18n';
  import MenuColumnFieldDrawer from '/@/views/gxadmin/system/menu/add_button/MenuColumnFieldDrawer.vue';
  import MenuColumnQuickDrawer from '/@/views/gxadmin/system/menu/add_button/MenuColumnQuickDrawer.vue';
