...
<script lang="ts">
  ...
  import BasicSetting from '/@/views/gxadmin/system/code-generator/template/design/basic-setting/index.vue';
  import FormDesign from '/@/views/gxadmin/system/code-generator/template/design/form-design/index.vue';
  import TableDesign from '/@/views/gxadmin/system/code-generator/template/design/table-design/index.vue';
  import { createOrUpdate } from '/@/views/gxadmin/system/code-generator/template/api';
